...
namespace ZFTest\Doctrine\Audit\Options;

use ZF\Doctrine\Audit\Options\ModuleOptions
    , ZF\Doctrine\Audit\Tests\Util\ServiceManagerFactory
    , ZFTest\Doctrine\Audit\Bootstrap
    ;
...
class ModuleOptionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testModuleOptionDefaults()
    {
        ...
        $moduleOptions->setAuditService($serviceManager->get('ZF\Doctrine\Audit\Service\AuditService'));
    }
